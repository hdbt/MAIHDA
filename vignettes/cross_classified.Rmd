...
- Few context levels identify the context variance weakly. The
  `maihda_country_data` example has only 6 countrie resulting in imprecise estimates and `lme4` may fit it singular. Prefer many-level contexts, or `engine = "brms"`, whose priors
