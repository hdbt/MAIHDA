...
departure from additivity that is genuinely intersectional). That conclusion is defensible only, 
...
sample size stays fixed, so cell counts fall away quickly. Estimating an interaction variancemfrom
...
A third of the strata hold fewer than five individuals. This is not an unsual case as it often the situation
...
were certain; `brms` reports an interval that includes the true share and makes the
