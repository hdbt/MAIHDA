...
- [`plot(`*`<maihda_describe>`*`)`](https://hdbt.github.io/MAIHDA/reference/plot.maihda_describe.md)
...
- [`print(`*`<maihda_describe>`*`)`](https://hdbt.github.io/MAIHDA/reference/print.maihda_describe.md)
