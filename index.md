...
Limitations: the wemix engine covers the canonical `gaussian(identity)`
/ `binomial(logit)` MAIHDA with a single `(1 | stratum)` intercept.
...
is a upcoming future extension.
