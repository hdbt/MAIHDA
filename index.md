...
``` text
Bulut (2025). *MAIHDA: Multilevel Analysis of Individual Heterogeneity and Discriminatory Accuracy.* R package version 0.3.0, https://github.com/hdbt/MAIHDA. doi: 10.32614/CRAN.package.MAIHDA
```
