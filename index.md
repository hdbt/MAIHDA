...
stratum-level predictions - **Visualizations**: Caterpillar plots, VPC
visualizations, Prediction plots and observed vs. shrunken estimates -
**Model Comparison**: Compare models with robust bootstrap confidence
intervals for VPC/ICC - **Proportional Change in Variance (PVC)**:
Quantify how much between-stratum variance is explained by additional
predictors
